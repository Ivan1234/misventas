                ...
                <table class="table table-bordered table-striped table-sm">
                    ...
                    <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                            <button type="button" class="btn btn-info btn-md" data-id_cliente="{{$client->id}}" data-nombre="{{$client->nombre}}" data-tipo_documento="{{$client->tipo_documento}}" data-num_documento="{{$client->num_documento}}" data-telefono="{{$client->telefono}}" data-email="{{$client->email}}" data-direccion="{{$client->direccion}}" data-toggle="modal" data-target="#abrirmodalEditar">
