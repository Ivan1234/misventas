            ...
            <table class="table table-bordered table-striped table-sm">
                ...
                <tbody>
                   ...
                   <tr>
                    ...
                    <td>
                        <img src="{{asset('storage/img/producto/'.$prod->imagen)}}" id="Imagen1" alt="{{$prod->nombre}}" class="img-responsive" with="100px" height="100px">
                    </td>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-danger btn-md">
                            <i class="fa fa-times fa-2x"></i>Desactivo
                        </button>
                        @endif
                    </td>

                    <td>
                        <button type="button" class="btn btn-info btn-md" data-id_producto="{{$prod->id}}" data-id_categoria="{{$prod->idcategoria}}" data-stock="{{$prod->stock}}" data-nombre="{{$prod->nombre}}" data-precio_venta="{{$prod->precio_venta}}" data-codigo="{{$prod->codigo}}" data-toggle="modal" data-target="#abrirmodalEditar">
