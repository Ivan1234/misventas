                            ...
                            <tbody>
                               ...
                               @foreach($categorias as $cat)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-info btn-md" data-id_categoria="{{$cat->id}}" data-nombre="{{$cat->name}}" data-descripcion="{{$cat->description}}" data-toggle="modal" data-target="#abrirmodalEditar">
